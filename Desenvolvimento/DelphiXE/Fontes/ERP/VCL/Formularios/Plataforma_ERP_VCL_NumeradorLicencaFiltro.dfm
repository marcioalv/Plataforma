object PlataformaERPVCLNumeradorLicencaFiltro: TPlataformaERPVCLNumeradorLicencaFiltro
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Filtros para localiza'#231#227'o de numeradores por licen'#231'a'
  ClientHeight = 266
  ClientWidth = 425
  Color = clBtnFace
