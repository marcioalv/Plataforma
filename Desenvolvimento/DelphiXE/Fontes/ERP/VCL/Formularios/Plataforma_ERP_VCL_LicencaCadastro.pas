...
// Descrição: Formulário com o cadastro de licenças.
//
...
type
  ...
  private
    ...
    function  LogDadosGerar(argLicencaID: Integer = 0): string;
  public
...
//
procedure TPlataformaERPVCLLicencaCadastro.mniAtualizarClick(Sender: TObject);
begin
  FormularioAtualizar;
end;

procedure TPlataformaERPVCLLicencaCadastro.mniNovoClick(Sender: TObject);
begin
  FormularioNovo;
end;

procedure TPlataformaERPVCLLicencaCadastro.mniExcluirClick(Sender: TObject);
begin
  FormularioExcluir;
end;

procedure TPlataformaERPVCLLicencaCadastro.mniAlterarClick(Sender: TObject);
begin
  FormularioAlterar;
end;

procedure TPlataformaERPVCLLicencaCadastro.mniGravarClick(Sender: TObject);
begin
  FormularioGravar;
end;

procedure TPlataformaERPVCLLicencaCadastro.mniCancelarClick(Sender: TObject);
begin
  FormularioCancelar;
end;
...
//
procedure TPlataformaERPVCLLicencaCadastro.edtCodigoEnter(Sender: TObject);
begin
  if not VCLEditEntrar(edtCodigo) then Exit;
end;

procedure TPlataformaERPVCLLicencaCadastro.edtCodigoKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_CODIGO);
end;

procedure TPlataformaERPVCLLicencaCadastro.edtCodigoKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  Exit;
end;

procedure TPlataformaERPVCLLicencaCadastro.edtCodigoExit(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLLicencaCadastro.edtCodigoCadastradoClick(Sender: TObject);
var
...
begin
  ...
  locFormulario.pubLicencaID := StringIntegerConverter(edtCodigoCadastradoID.Text);
...
//
procedure TPlataformaERPVCLLicencaCadastro.edtDescricaoEnter(Sender: TObject);
begin
  if not VCLEditEntrar(edtDescricao) then Exit;
end;

procedure TPlataformaERPVCLLicencaCadastro.edtDescricaoKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_ALFANUMERICA);
end;

procedure TPlataformaERPVCLLicencaCadastro.edtDescricaoKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  Exit;
end;

procedure TPlataformaERPVCLLicencaCadastro.edtDescricaoExit(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLLicencaCadastro.chkBloqueadoEnter(Sender: TObject);
begin
  if not VCLCheckBoxEntrar(chkBloqueado) then Exit;
end;

procedure TPlataformaERPVCLLicencaCadastro.chkBloqueadoKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_LIVRE);
end;

procedure TPlataformaERPVCLLicencaCadastro.chkBloqueadoExit(Sender: TObject);
begin
...
// Ativo.
//
procedure TPlataformaERPVCLLicencaCadastro.chkAtivoEnter(Sender: TObject);
begin
  if not VCLCheckBoxEntrar(chkAtivo) then Exit;
end;

procedure TPlataformaERPVCLLicencaCadastro.chkAtivoKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_LIVRE);
end;

procedure TPlataformaERPVCLLicencaCadastro.chkAtivoExit(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLLicencaCadastro.btnNovoClick(Sender: TObject);
begin
  FormularioNovo;
end;
...
//
procedure TPlataformaERPVCLLicencaCadastro.btnAlterarClick(Sender: TObject);
begin
  FormularioAlterar;
end;
...
//
procedure TPlataformaERPVCLLicencaCadastro.btnGravarClick(Sender: TObject);
begin
  FormularioGravar;
end;
...
//
procedure TPlataformaERPVCLLicencaCadastro.btnCancelarClick(Sender: TObject);
begin
  FormularioCancelar;
end;
...
begin
  ...
  //
  locDadosPopulados := (StringIntegerConverter(edtLicencaID.Text) > 0);
  ...
  //
  tabCadastro.TabVisible  := Plataforma_ERP_UsuarioRotina('ERP_LICENCA_CADASTRO_ABA_CADASTRO');
  tabAuditoria.TabVisible := Plataforma_ERP_UsuarioRotina('ERP_LICENCA_CADASTRO_ABA_AUDITORIA');
      
  mniAtualizar.Visible := (mniAtualizar.Visible) and (Plataforma_ERP_UsuarioRotina('ERP_LICENCA_CADASTRO_ATUALIZAR'));
  mniNovo.Visible      := (mniNovo.Visible)      and (Plataforma_ERP_UsuarioRotina('ERP_LICENCA_CADASTRO_NOVO'));
  mniExcluir.Visible   := (mniExcluir.Visible)   and (Plataforma_ERP_UsuarioRotina('ERP_LICENCA_CADASTRO_EXCLUIR'));
  mniAlterar.Visible   := (mniAlterar.Visible)   and (Plataforma_ERP_UsuarioRotina('ERP_LICENCA_CADASTRO_ALTERAR'));
...
//
procedure TPlataformaERPVCLLicencaCadastro.FormularioAtualizar;
begin
  //
...
//
procedure TPlataformaERPVCLLicencaCadastro.FormularioNovo;
begin
  //
  // Limpa os componentes do formulário.
  //
...
const
  ...
  ERRO_MENSAGEM    : string = 'Impossível consultar dados da licença!';
var
...
begin
  ...
  try
    ...
    begin
      ...
      locADOConnection.Close;
      FreeAndNil(locADOConnection);
      locLogMensagem := 'Ocorreu algum erro ao executar o comando SQL para consultar um registro da tabela [licenca]!';
  ...
  begin
    ...
    edtLicencaID.Text    := IntegerStringConverter(locADOQuery.FieldByName('licenca_id').AsInteger, True);
...
//
procedure TPlataformaERPVCLLicencaCadastro.FormularioAlterar;
begin
  //
  // Componentes ligados para edição.
  //
...
//
procedure TPlataformaERPVCLLicencaCadastro.FormularioGravar;
const
  PROCEDIMENTO_NOME: string = 'FormularioGravar';
  ERRO_MENSAGEM    : string = 'Impossível gravar dados da licença!';
var
  locADOConnection: TADOConnection;
  locADOQuery     : TADOQuery;
  locLogMensagem  : string;
...
begin
  ...
  //
  if edtLicencaID.Text = STR_NOVO then
    locInsert := True
  else
    locInsert := False;
  ...
  if locCodigo = '' then
  begin
    VCLConsistenciaExibir('O código da licença deve ser informado!');
    VCLPageControlFocar(pagFormulario, TAB_CADASTRO, edtCodigo);
    Exit;
  end;
  ...
  begin
    VCLConsistenciaExibir('A descrição da licença deve ser informada!');
  ...
  //
  // Determina se o código da licença já existe no banco de dados para um outro registro.
  //
  locADOQuery.Close;
  locADOQuery.SQL.Clear;
  ...
  locADOQuery.SQL.Add('  [licenca] WITH (NOLOCK)               ');
  locADOQuery.SQL.Add('WHERE                                   ');
  locADOQuery.SQL.Add('  [licenca].[codigo]      = :codigo AND ');
  locADOQuery.SQL.Add('  [licenca].[licenca_id] <> :licenca_id ');
  ...
  try
    ...
    begin
      ...
      locADOConnection.Close;
      FreeAndNil(locADOConnection);
      locLogMensagem := 'Ocorreu algum problema ao executar query para selecionar o mesmo código da licença em um outro registro!';
      Plataforma_ERP_Logar(True, ERRO_MENSAGEM, locLogMensagem, locExcecao.Message, FONTE_NOME, PROCEDIMENTO_NOME);
      VCLErroExibir(ERRO_MENSAGEM, locLogMensagem, locExcecao.Message);
      Exit;
    end;
  ...
  begin
    ...
    locADOConnection.Close;
    FreeAndNil(locADOConnection);
    locLogMensagem := 'O código "' + locCodigo + '" informado para a licença já existe em algum outro cadastro!';
  ...
  begin
    ...
    try
      ...
      begin
        ...
        locADOConnection.Close;
        FreeAndNil(locADOConnection);
        locLogMensagem := 'Ocorreu algum erro ao executar o comando SQL para consultar se o contador de atualizações confere na tabela [licenca]!';
        Plataforma_ERP_Logar(True, ERRO_MENSAGEM, locLogMensagem, locExcecao.Message, FONTE_NOME, PROCEDIMENTO_NOME);
        VCLErroExibir(ERRO_MENSAGEM, locLogMensagem, locExcecao.Message);
        Exit
      end;
  ...
  begin
    try
      locLicencaID := Plataforma_ERP_ADO_NumeradorBaseDeterminar(locADOConnection, NUMERADOR_LICENCA_ID);
    except
      on locExcecao: Exception do
      begin
        ...
        locADOConnection.Close;
        FreeAndNil(locADOConnection);
        locLogMensagem := 'Impossível determinar o próximo numerador para a licença!';
        Plataforma_ERP_Logar(True, ERRO_MENSAGEM, locLogMensagem, locExcecao.Message, FONTE_NOME, PROCEDIMENTO_NOME);
        VCLErroExibir(ERRO_MENSAGEM, locLogMensagem, locExcecao.Message);
        Exit
      end;
  ...
  begin
    ...
    // Insere dados.
    //
    locADOQuery.SQL.Add('INSERT INTO [licenca] ( ');
  ...
  try
    ...
    begin
      ...
      locADOConnection.Close;
      FreeAndNil(locADOConnection);
      locLogMensagem := 'Ocorreu algum erro ao executar o comando SQL para inserir o registro na tabela [licenca]!';
      Plataforma_ERP_Logar(True, ERRO_MENSAGEM, locLogMensagem, locExcecao.Message, FONTE_NOME, PROCEDIMENTO_NOME);
      VCLErroExibir(ERRO_MENSAGEM, locLogMensagem, locExcecao.Message);
      Exit
    end;
  ...
  try
    ...
    begin
      ...
      locADOConnection.Close;
      FreeAndNil(locADOConnection);
      locLogMensagem := 'Ocorreu algum erro ao executar o comando SQL para determinar o novo contador de updates do registro na tabela [licenca]!';
      Plataforma_ERP_Logar(True, ERRO_MENSAGEM, locLogMensagem, locExcecao.Message, FONTE_NOME, PROCEDIMENTO_NOME);
      VCLErroExibir(ERRO_MENSAGEM, locLogMensagem, locExcecao.Message);
      Exit
    end;   
  ...
  // Log dados.
  //
  locRegistroAcaoLogDados := LogDadosGerar(locLicencaID);
  ...
  //
  edtLicencaID.Text := IntegerStringConverter(locLicencaID);
  ...
  //  
  try
    Plataforma_ERP_ADO_LogOcorrenciaInserir(locRegistroAcao, locLicencaID, locCodigo, 'licenca', locRegistroAcaoLogMsg, locRegistroAcaoLogDados);
  except
    on locExcecao: Exception do
    begin
  ...
  // Licença gravada!
  //
  VCLInformacaoExibir('Licença gravada com sucesso!');
end;

//
// Procedimento para excluir os dados deste cadastro.
//
procedure TPlataformaERPVCLLicencaCadastro.FormularioExcluir;
const
  PROCEDIMENTO_NOME: string = 'FormularioExcluir';
  ERRO_MENSAGEM    : string = 'Impossível excluir dados da licença!';
var
  locADOConnection  : TADOConnection;
  locADOQuery       : TADOQuery;
  locLogMensagem    : string;
  locLicencaID      : Integer;
  locLicencaLogDados: string;
begin
  //
  // Carrega variáveis com o conteúdo dos componentes.
  //
  ...
  // Log dados.
  //
  locLicencaLogDados := LogDadosGerar;
  ...
  //
  // Comando SQL para excluir um registro da tabela licença.
  //
  locADOQuery.Close;
  locADOQuery.SQL.Clear;
  ...
  try
    ...
    begin
      ...
      locADOConnection.Close;
      FreeAndNil(locADOConnection);
      locLogMensagem := 'Ocorreu algum problema ao executar query para deletar os registros na tabela [licenca]!';
      Plataforma_ERP_Logar(True, ERRO_MENSAGEM, locLogMensagem, locExcecao.Message, FONTE_NOME, PROCEDIMENTO_NOME);
      VCLErroExibir(ERRO_MENSAGEM, locLogMensagem, locExcecao.Message);
      Exit;
    end;
  ...
  //
  try
    Plataforma_ERP_ADO_LogOcorrenciaInserir(REGISTRO_ACAO_EXCLUSAO, locLicencaID, edtCodigo.Text, 'licenca', 'Registro excluído com sucesso!', locLicencaLogDados);
  except
  end;
  VCLInformacaoExibir('Licença excluída com sucesso!');
end;

//
// Procedimento para cancelar a edição dos dados do formulário.
//
procedure TPlataformaERPVCLLicencaCadastro.FormularioCancelar;
var
  locLicencaID: Integer;
begin
  //
  ...
  //
  FormularioPopular(locLicencaID);
...
//
procedure TPlataformaERPVCLLicencaCadastro.FormularioCodigoSugerir;
const
  PROCEDIMENTO_NOME: string = 'FormularioCodigoSugerir';
  ERRO_MENSAGEM    : string = 'Impossível sugerir informações sobre o próximo código da licença!';
var
  locADOConnection: TADOConnection;
  locADOQuery     : TADOQuery;
  locLogMensagem  : string;
begin
  ...
  locADOQuery.SQL.Add('  [licenca].[ins_server_dt_hr] DESC, ');
  locADOQuery.SQL.Add('  [licenca].[codigo] DESC            ');
  ...
  try
    ...
    begin
      ...
      locADOConnection.Close;
      FreeAndNil(locADOConnection);
      locLogMensagem := 'Ocorreu algum erro ao executar o comando SQL para consultar último cadastro na tabela [licenca]!';
      Plataforma_ERP_Logar(True, ERRO_MENSAGEM, locLogMensagem, locExcecao.Message, FONTE_NOME, PROCEDIMENTO_NOME);
      VCLErroExibir(ERRO_MENSAGEM, locLogMensagem, locExcecao.Message);
      Exit;
    end;
  ...
  begin
    ...
    edtCodigoCadastradoID.Text := IntegerStringConverter(locADOQuery.FieldByName('licenca_id').AsInteger);
...
//
function TPlataformaERPVCLLicencaCadastro.LogDadosGerar(argLicencaID: Integer = 0): string;
var
  locLicencaID: Integer;
begin
  if argLicencaID <= 0 then
    locLicencaID := StringIntegerConverter(edtLicencaID.Text)
  else
    locLicencaID := argLicencaID;

  Result := '';
  LogDadosIntegerDescrever('ID da licença', locLicencaID,         Result);
