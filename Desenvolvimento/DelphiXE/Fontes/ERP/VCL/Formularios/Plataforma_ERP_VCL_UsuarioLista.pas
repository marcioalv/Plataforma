...
const
  ...
  LVW_LISTA_USUARIO_BASE_ID      : Integer = 1;
  LVW_LISTA_USARIO_BASE_DESCRICAO: Integer = 2;
...
begin
  ...
  begin
    ...
    locADOQuery.SQL.Add('               [usuario_log].[usuario_base_id]  = [usuario].[usuario_base_id] AND         ');
  ...
  begin
    ...
    begin
      ...
      locListItem.SubItems.Add(IntegerStringConverter(locADOQuery.FieldByName('usuario_base_id').AsInteger));
      locListItem.SubItems.Add(locADOQuery.FieldByName('usuario_base_descricao').AsString);
