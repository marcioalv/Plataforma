//
// Arquivo..: Plataforma_ERP_VCL_NumeradorBaseFiltro.pas
// Projeto..: ERP
// Fonte....: Formulário VCL
// Criação..: 14/Agosto/2018
// Autor....: Marcio Alves (marcioalv@yahoo.com.br)
// Descrição: Formulário com os parâmetros de filtro para a listagem de numeradores por base.
//
// Histórico de alterações:
//   Nenhuma alteração até o momento.
//

unit Plataforma_ERP_VCL_NumeradorBaseFiltro;
...
type
  TPlataformaERPVCLNumeradorBaseFiltro = class(TForm)
...
var
  PlataformaERPVCLNumeradorBaseFiltro: TPlataformaERPVCLNumeradorBaseFiltro;
...
const
  ...
  FONTE_NOME: string = 'Plataforma_ERP_VCL_NumeradorBaseFiltro';

//
// Evento de criação do formulário.
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.FormCreate(Sender: TObject);
begin
  //
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.FormShow(Sender: TObject);
begin
  //
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.mniLocalizarClick(Sender: TObject);
begin
  FormularioLocalizar;
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.mniLimparClick(Sender: TObject);
begin
  FormularioLimpar;
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.mniMinimizarClick(Sender: TObject);
begin
  VCLSDIMinimizar;
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.mniFecharClick(Sender: TObject);
begin
  Close;
end;
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.edtCodigoEnter(Sender: TObject);
begin
  if not VCLEditEntrar(edtCodigo) then Exit;
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.edtCodigoKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_ALFANUMERICA);
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.edtCodigoExit(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.cbxBloqueadoEnter(Sender: TObject);
begin
  if not VCLComboBoxEntrar(cbxBloqueado) then Exit;
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.cbxBloqueadoKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_ALFANUMERICA);
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.cbxBloqueadoExit(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.cbxAtivoEnter(Sender: TObject);
begin
  if not VCLComboBoxEntrar(cbxAtivo) then Exit;
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.cbxAtivoKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_ALFANUMERICA);
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.cbxAtivoExit(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.medInsDtHrInicialEnter(Sender: TObject);
begin
  if not VCLMaskEditEntrar(medInsDtHrInicial) then Exit;
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.medInsDtHrInicialKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_DATA);
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.medInsDtHrInicialKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = F2 then Plataforma_ERP_VCL_DataSelecionar(medInsDtHrInicial);
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.medInsDtHrInicialExit(Sender: TObject);
begin
  if not VCLMaskEditSair(medInsDtHrInicial) then Exit;
  if not VCLMaskEditDataValidar(medInsDtHrInicial) then Exit;
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.imgInsDtHrInicialClick(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.medInsDtHrFinalEnter(Sender: TObject);
begin
  if not VCLMaskEditEntrar(medInsDtHrFinal) then Exit;
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.medInsDtHrFinalKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_DATA);
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.medInsDtHrFinalKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = F2 then Plataforma_ERP_VCL_DataSelecionar(medInsDtHrFinal);
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.medInsDtHrFinalExit(Sender: TObject);
begin
  if not VCLMaskEditSair(medInsDtHrFinal) then Exit;
  if not VCLMaskEditDataValidar(medInsDtHrFinal) then Exit;
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.imgInsDtHrFinalClick(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.medUpdDtHrInicialEnter(Sender: TObject);
begin
  if not VCLMaskEditEntrar(medUpdDtHrInicial) then Exit;
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.medUpdDtHrInicialKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_DATA);
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.medUpdDtHrInicialKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = F2 then Plataforma_ERP_VCL_DataSelecionar(medUpdDtHrInicial);
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.medUpdDtHrInicialExit(Sender: TObject);
begin
  if not VCLMaskEditSair(medUpdDtHrInicial) then Exit;
  if not VCLMaskEditDataValidar(medUpdDtHrInicial) then Exit;
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.imgUpdDtHrInicialClick(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.medUpdDtHrFinalEnter(Sender: TObject);
begin
  if not VCLMaskEditEntrar(medUpdDtHrFinal) then Exit;
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.medUpdDtHrFinalKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_DATA);
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.medUpdDtHrFinalKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = F2 then Plataforma_ERP_VCL_DataSelecionar(medUpdDtHrFinal);
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.medUpdDtHrFinalExit(Sender: TObject);
begin
  if not VCLMaskEditSair(medUpdDtHrFinal) then Exit;
  if not VCLMaskEditDataValidar(medUpdDtHrFinal) then Exit;
end;

procedure TPlataformaERPVCLNumeradorBaseFiltro.imgUpdDtHrFinalClick(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.btnLocalizarClick(Sender: TObject);
begin
  FormularioLocalizar;
end;
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.btnLimparClick(Sender: TObject);
begin
  FormularioLimpar;
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.btnMinimizarClick(Sender: TObject);
begin
  VCLSDIMinimizar;
end;
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.btnFecharClick(Sender: TObject);
begin
  Close;
end;
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.FormularioInicializar;
begin
  //
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.FormularioLimpar;
begin
...
//
procedure TPlataformaERPVCLNumeradorBaseFiltro.FormularioLocalizar;
begin
