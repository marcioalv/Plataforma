...
begin
  ...
  // Menu - Ações.
  //
  mniLocalizar.Visible  := Plataforma_ERP_UsuarioRotina('ERP_ROTINA_APLICACAO_LISTA_LOCALIZAR');
  mniAtualizar.Visible  := Plataforma_ERP_UsuarioRotina('ERP_ROTINA_APLICACAO_LISTA_ATUALIZAR');
  mniNovo.Visible       := Plataforma_ERP_UsuarioRotina('ERP_ROTINA_APLICACAO_LISTA_NOVO');
  mniSelecionar.Visible := Plataforma_ERP_UsuarioRotina('ERP_ROTINA_APLICACAO_LISTA_SELECIONAR');
