//
// Arquivo..: Plataforma_ERP_VCL_ColigadaFiltro.pas
// Projeto..: ERP                                                         
// Fonte....: Formulário VCL
// Criação..: 05/Julho/2018
// Autor....: Marcio Alves (marcioalv@yahoo.com.br)
// Descrição: Formulário com os parâmetros de filtro para a listagem de coligadas.
//
// Histórico de alterações:
//   Nenhuma alteração até o momento.
//

unit Plataforma_ERP_VCL_ColigadaFiltro;
...
type
  TPlataformaERPVCLColigadaFiltro = class(TForm)
    ...
    lblColigadaIDAte: TLabel;
    edtColigadaIDInicial: TEdit;
    edtColigadaIDFinal: TEdit;
    lblBloqueado: TLabel;
    lblAtivo: TLabel;
    ...
    procedure edtColigadaIDInicialEnter(Sender: TObject);
    procedure edtColigadaIDInicialExit(Sender: TObject);
    procedure edtColigadaIDInicialKeyPress(Sender: TObject; var Key: Char);
    procedure edtColigadaIDFinalEnter(Sender: TObject);
    procedure edtColigadaIDFinalExit(Sender: TObject);
    procedure edtColigadaIDFinalKeyPress(Sender: TObject; var Key: Char);
  ...
  public
    ...
    pubBloqueado        : string;
    pubAtivo            : string;
    pubColigadaIDInicial: Integer;
    pubColigadaIDFinal  : Integer;
...
var
  PlataformaERPVCLColigadaFiltro: TPlataformaERPVCLColigadaFiltro;
...
const
  ...
  FONTE_NOME: string = 'Plataforma_ERP_VCL_ColigadaFiltro';

//
// Evento de criação do formulário.
//
procedure TPlataformaERPVCLColigadaFiltro.FormCreate(Sender: TObject);
begin
  //
  // Inicializa variáveis públicas.
  //
  pubClicouFechar      := True;
  pubColigadaIDInicial := 0;
  pubColigadaIDFinal   := 0;
  pubCodigoInicial     := '';
  pubCodigoFinal       := '';
  pubNome              := '';
  pubBloqueado         := '';
...
//
procedure TPlataformaERPVCLColigadaFiltro.FormShow(Sender: TObject);
begin
  //
  ...
  edtColigadaIDInicial.Text := IntegerStringConverter(pubColigadaIDInicial, True);
  edtColigadaIDFinal.Text   := IntegerStringConverter(pubColigadaIDFinal,   True);
  ...
  if pagFormulario.ActivePageIndex = TAB_AUDITORIA then edtColigadaIDInicial.SetFocus;
end;

//
// Evento de pressionamento de teclas no formulário.
//
procedure TPlataformaERPVCLColigadaFiltro.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
//
procedure TPlataformaERPVCLColigadaFiltro.mniLocalizarClick(Sender: TObject);
begin
  FormularioLocalizar;
end;

procedure TPlataformaERPVCLColigadaFiltro.mniLimparClick(Sender: TObject);
begin
  FormularioLimpar;
end;

procedure TPlataformaERPVCLColigadaFiltro.mniMinimizarClick(Sender: TObject);
begin
  VCLSDIMinimizar;
end;

procedure TPlataformaERPVCLColigadaFiltro.mniFecharClick(Sender: TObject);
begin
  Close;
end;

//
// Eventos do componente "ID inicial" da coligada.
//
procedure TPlataformaERPVCLColigadaFiltro.edtColigadaIDInicialEnter(Sender: TObject);
begin
  if not VCLEditEntrar(edtColigadaIDInicial) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.edtColigadaIDInicialKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_NUMERICA_INTEIRA);
end;

procedure TPlataformaERPVCLColigadaFiltro.edtColigadaIDInicialExit(Sender: TObject);
begin
  if not VCLEditSair(edtColigadaIDInicial) then Exit;
end;

//
// Eventos do componente "ID final" da coligada.
//
procedure TPlataformaERPVCLColigadaFiltro.edtColigadaIDFinalEnter(Sender: TObject);
begin
  if not VCLEditEntrar(edtColigadaIDFinal) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.edtColigadaIDFinalKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_NUMERICA_INTEIRA);
end;

procedure TPlataformaERPVCLColigadaFiltro.edtColigadaIDFinalExit(Sender: TObject);
begin
  if not VCLEditSair(edtColigadaIDFinal) then Exit;
end;

//
// Eventos do componente "código inicial".
//
procedure TPlataformaERPVCLColigadaFiltro.edtCodigoInicialEnter(Sender: TObject);
begin
  if not VCLEditEntrar(edtCodigoInicial) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.edtCodigoInicialKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_CODIGO);
end;

procedure TPlataformaERPVCLColigadaFiltro.edtCodigoInicialExit(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLColigadaFiltro.edtCodigoFinalEnter(Sender: TObject);
begin
  if not VCLEditEntrar(edtCodigoFinal) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.edtCodigoFinalKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_CODIGO);
end;

procedure TPlataformaERPVCLColigadaFiltro.edtCodigoFinalExit(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLColigadaFiltro.edtNomeEnter(Sender: TObject);
begin
  if not VCLEditEntrar(edtNome) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.edtNomeKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_ALFANUMERICA);
end;

procedure TPlataformaERPVCLColigadaFiltro.edtNomeExit(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLColigadaFiltro.cbxBloqueadoEnter(Sender: TObject);
begin
  if not VCLComboBoxEntrar(cbxBloqueado) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.cbxBloqueadoKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_ALFANUMERICA);
end;

procedure TPlataformaERPVCLColigadaFiltro.cbxBloqueadoExit(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLColigadaFiltro.cbxAtivoEnter(Sender: TObject);
begin
  if not VCLComboBoxEntrar(cbxAtivo) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.cbxAtivoKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_ALFANUMERICA);
end;

procedure TPlataformaERPVCLColigadaFiltro.cbxAtivoExit(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLColigadaFiltro.medInsDtHrInicialEnter(Sender: TObject);
begin
  if not VCLMaskEditEntrar(medInsDtHrInicial) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.medInsDtHrInicialKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_DATA);
end;

procedure TPlataformaERPVCLColigadaFiltro.medInsDtHrInicialKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = F2 then Plataforma_ERP_VCL_DataSelecionar(medInsDtHrInicial);
end;

procedure TPlataformaERPVCLColigadaFiltro.medInsDtHrInicialExit(Sender: TObject);
begin
  if not VCLMaskEditSair(medInsDtHrInicial) then Exit;
  if not VCLMaskEditDataValidar(medInsDtHrInicial) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.imgInsDtHrInicialClick(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLColigadaFiltro.medInsDtHrFinalEnter(Sender: TObject);
begin
  if not VCLMaskEditEntrar(medInsDtHrFinal) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.medInsDtHrFinalKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_DATA);
end;

procedure TPlataformaERPVCLColigadaFiltro.medInsDtHrFinalKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = F2 then Plataforma_ERP_VCL_DataSelecionar(medInsDtHrFinal);
end;

procedure TPlataformaERPVCLColigadaFiltro.medInsDtHrFinalExit(Sender: TObject);
begin
  if not VCLMaskEditSair(medInsDtHrFinal) then Exit;
  if not VCLMaskEditDataValidar(medInsDtHrFinal) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.imgInsDtHrFinalClick(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLColigadaFiltro.medUpdDtHrInicialEnter(Sender: TObject);
begin
  if not VCLMaskEditEntrar(medUpdDtHrInicial) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.medUpdDtHrInicialKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_DATA);
end;

procedure TPlataformaERPVCLColigadaFiltro.medUpdDtHrInicialKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = F2 then Plataforma_ERP_VCL_DataSelecionar(medUpdDtHrInicial);
end;

procedure TPlataformaERPVCLColigadaFiltro.medUpdDtHrInicialExit(Sender: TObject);
begin
  if not VCLMaskEditSair(medUpdDtHrInicial) then Exit;
  if not VCLMaskEditDataValidar(medUpdDtHrInicial) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.imgUpdDtHrInicialClick(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLColigadaFiltro.medUpdDtHrFinalEnter(Sender: TObject);
begin
  if not VCLMaskEditEntrar(medUpdDtHrFinal) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.medUpdDtHrFinalKeyPress(Sender: TObject; var Key: Char);
begin
  VCLDigitacaoHabilitar(Self, Key, VCL_DIGITACAO_DATA);
end;

procedure TPlataformaERPVCLColigadaFiltro.medUpdDtHrFinalKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = F2 then Plataforma_ERP_VCL_DataSelecionar(medUpdDtHrFinal);
end;

procedure TPlataformaERPVCLColigadaFiltro.medUpdDtHrFinalExit(Sender: TObject);
begin
  if not VCLMaskEditSair(medUpdDtHrFinal) then Exit;
  if not VCLMaskEditDataValidar(medUpdDtHrFinal) then Exit;
end;

procedure TPlataformaERPVCLColigadaFiltro.imgUpdDtHrFinalClick(Sender: TObject);
begin
...
//
procedure TPlataformaERPVCLColigadaFiltro.btnLocalizarClick(Sender: TObject);
begin
  FormularioLocalizar;
end;
...
//
procedure TPlataformaERPVCLColigadaFiltro.btnLimparClick(Sender: TObject);
begin
  FormularioLimpar;
...
//
procedure TPlataformaERPVCLColigadaFiltro.btnMinimizarClick(Sender: TObject);
begin
  VCLSDIMinimizar;
end;
...
//
procedure TPlataformaERPVCLColigadaFiltro.btnFecharClick(Sender: TObject);
begin
  Close;
end;
...
//
procedure TPlataformaERPVCLColigadaFiltro.FormularioInicializar;
begin
  //
  // Controla os componentes conforme permissão de acesso.
  //
  pagFormulario.Pages[TAB_CADASTRO].TabVisible  := Plataforma_ERP_UsuarioRotina('ERP_COLIGADA_FILTRO_CADASTRO');
  pagFormulario.Pages[TAB_AUDITORIA].TabVisible := Plataforma_ERP_UsuarioRotina('ERP_COLIGADA_FILTRO_AUDITORIA');
...
//
procedure TPlataformaERPVCLColigadaFiltro.FormularioLimpar;
begin
  ...
  VCLEditLimpar    (edtColigadaIDInicial);
  VCLEditLimpar    (edtColigadaIDFinal);
...
//
procedure TPlataformaERPVCLColigadaFiltro.FormularioLocalizar;
begin
  ...
  pubColigadaIDInicial := StringIntegerConverter(edtColigadaIDInicial.Text);
  pubColigadaIDFinal   := StringIntegerConverter(edtColigadaIDFinal.Text);
