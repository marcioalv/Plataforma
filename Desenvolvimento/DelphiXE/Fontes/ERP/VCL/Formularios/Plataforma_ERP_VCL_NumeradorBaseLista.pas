...
begin
  ...
  // Menu - Ações.
  //
  mniLocalizar.Visible  := Plataforma_ERP_UsuarioRotina('ERP_NUMERADOR_BASE_LISTA_LOCALIZAR');
  mniAtualizar.Visible  := Plataforma_ERP_UsuarioRotina('ERP_NUMERADOR_BASE_LISTA_ATUALIZAR');
  mniNovo.Visible       := Plataforma_ERP_UsuarioRotina('ERP_NUMERADOR_BASE_LISTA_NOVO');
  mniSelecionar.Visible := Plataforma_ERP_UsuarioRotina('ERP_NUMERADOR_BASE_LISTA_SELECIONAR');
